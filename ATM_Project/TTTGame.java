...
ic1=new ImageIcon(ClassLoader.getSystemResource("icons/cat.jfif"));  
ic2=new ImageIcon(ClassLoader.getSystemResource("icons/cat1.jfif"));  
ic11=new ImageIcon(ClassLoader.getSystemResource("icons/cat2.jfif"));  
ic22=new ImageIcon(ClassLoader.getSystemResource("icons/cat3.jfif"));  
...
for(i=0;i<=7;i++){  
  ...
  Icon icon3=b[(a[i][3]-1)].getIcon();  
    ...
    JOptionPane.showMessageDialog(TTTGame.this,"!!!YOU won!!! click reset");     
         break;  
                   }  
             else if(icon1==ic2){   
             ...
             b[(a[i][3]-1)].setIcon(ic22);   
               JOptionPane.showMessageDialog(TTTGame.this,"won! click reset");  
                break;             
               }  
         }  
    }    
