...
public class Deposit extends JFrame implements ActionListener {
  ...
  JButton b2;
   ...
   l1=new JLabel("enter the amount you need to deposit");
 ...
 JOptionPane.showMessageDialog(null,"please enter the amount you need");
  ...
  Conn co=new Conn();
 String query="INSERT INTO `deposited`(`Pin`, `Date`, `Type`, `Amount`) VALUES('"+pinNumber+"','"+date+"','deposit','"+depAmount+"')";
 try{
 co.st.executeUpdate(query);
  JOptionPane.showMessageDialog(null,"Rs "+depAmount+" "+"is"+" "+"deposited successfully");
  setVisible(false);
